...
// adding animating class on scroll for main articles
...
window.addEventListener("scroll", () => addAnimationClass([...elements]));
// adding animating class on scorll for contact link list
const contactList = document.querySelector("ul.link-list");
window.addEventListener("scroll", () => {
  console.log(contactList.getBoundingClientRect().top);
  contactList.getBoundingClientRect().top < 1000
    ? contactList.classList.add("animate")
    : "";
});
